...
#define Opt_forceTransparent		(1LU<<14)
...
#define Opt2_smartResize			(1LU<<26)
#define Opt2_autohideTabbar			(1LU<<27)
#define Opt2_maximized				(1LU<<28)
#define Opt2_fullscreen				(1LU<<29)
