...
typedef enum {
    ...
    DBG_TABBAR	    = 0x00000080,
    DBG_TRANSPARENT = 0x00000100,
    DBG_ENCODING    = 0x00000200,
    DBG_MEMORY	    = 0x00000400,
    DBG_SESSION	    = 0x00000800,
    DBG_STRING	    = 0x00001000,
    DBG_RESOURCE    = 0x00002000,
    DBG_XFTACS	    = 0x00004000,
    DBG_MISC	    = 0x00008000,
} dbgmask_t;
